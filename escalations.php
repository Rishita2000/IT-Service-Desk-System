...
<html>
    <head>
        ...
        if(isset($_POST['firstname'],$_POST['lastname'],$_POST['department'],$_POST['email'],$_POST['computerid'],$_POST['escalationReason'])){
            ...
            $escalationReason = $_POST['escalationReason'];

            $max_id_query = "SELECT MAX(id) FROM escalationforms";       

            $getmaxIdQueryResult = mysqli_query($con,$max_id_query);
            $row = mysqli_fetch_array($getmaxIdQueryResult);
            $highest_id = 'CID' . ($row[0]+1) . '';
            
            $insertQuery = mysqli_query($con,"insert into escalationforms(firstName,lastName,email,department,computerid,escalationReason) 
                          values ('$firstname','$lastname','$email','$department','$highest_id','$escalationReason')");

            if($insertQuery){
               $_SESSION['status'] = "Escalation Created Successfully !!!!!!!!";
            }
            else{
               $_SESSION['errStatus'] = "Error While Creating the Escalation !!!!!!!!";
            }
                    ...
                    <ul class="navbar-nav">
                      <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="tickets.php">All Tickets</a></li>
                          <li><a class="dropdown-item" href="Sla.php">Missed SLA</a></li>
                        </ul>
                      </li>
                    </ul>
                    <ul class="navbar-nav">
            ...
            <form class="container col-md-12 offset-md-4" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" >
               ...
               <section class="col-md-4">
                ...
                <section id="computerIdBox" class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="computerid" readonly>
                    
                    <hr>
                </section>
                <section class="col-md-4">
                    <label for="problem" id="problem" class="label label-default"><b>Escalation Reason</b></label>
                    <textarea name="escalationReason" id="escalationReason" cols="50" rows="5" class="form-control" required></textarea>
