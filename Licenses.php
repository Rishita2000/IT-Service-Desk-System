  ...
  <section class="commongrid">  
      ...
      <main>
        <div class="intro_Licensing">
          <h1 align="center">License Tracking</h1>
        </div>
        <section class="Search">
            <form action="Licenses.php" method=post> 
                            ...
                            <tbody>
                              <?php
                                if(isset($_POST['search'])){
                                    ...
                                    $query = "select * from `licenses` where CONCAT(`productname`,`manufacturer`,`purchasedate`,`type`) like '%".$valueToSearch."%'";
